...
set EXE="%~dp0\SocketServiceWrapper.exe"
set SERVICE="NextLabs EMSMB FileInfo Server"
if "%1"=="unreg" (
...
set DESC=sc description %SERVICE%  "Nextlabs Entitlement Manager SMB FileInfo Server"
echo !DESC!
!DESC!
